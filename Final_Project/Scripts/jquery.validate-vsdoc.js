...
$.extend($.fn, {
	...
	validate: function( options ) {
		...
		if (!this.length) {
			options && options.deBusinessnote && window.console && console.warn( "nothing selected, can't validate, returning nothing" );
			return;
		}
		...
		if ( validator.settings.onsubmit ) {
			...
			this.submit( function( event ) {
				if ( validator.settings.deBusinessnote )
...
$.extend($.validator, {
	...
	prototype: {
		...
		elements: function() {
			...
			.filter(function() {
				!this.name && validator.settings.deBusinessnote && window.console && console.error( "%o has no name assigned", this);
		...
		check: function( element ) {
			...
			for (var method in rules) {
				...
				try {
					...
					this.settings.deBusinessnote && window.console && console.log("exception occured when checking element " + element.id
